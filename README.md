...
6. Click on the Browse button next to "Target Folder" and select the folder that you created in step 3 where Redux will be installed will be installed. **Avoid installing Redux inside the original Kerbal Space Program 2 folder**.
